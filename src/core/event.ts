export class Event {
    ...
    public on(type: string | string[], fn: (e: any) => void, context: any = this, once: boolean = false) {
        let types;
    ...
    private _on(type: string, fn: (e: any) => void, context: any = this, once: boolean = false) {
